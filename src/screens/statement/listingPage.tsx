...
import { Duty, Service, Operator, Bus } from "../../types/type";
...
const StatementListingPage = () => {
  ...
  const formatDateToUTC = (dateString: string, isEndDate: boolean = false) => {
    ...
    if (isEndDate) {
      date.setHours(23, 59, 59, 999); // Set to end of day for toDate
    } else {
      date.setHours(0, 0, 0, 0); // Set to start of day for fromDate
    }

    return date.toISOString();
  };

  // Fetch bus list on component mount
  useEffect(() => {
